  ...
  <body>
    ...
    <div class="container mt-5 mb-5">
      ...
      <div class="row justify-content-center">
        <div class="col-5">
          <form name="form" method="POST" action="{{ route('biodata.update', $data->id) }}" onsubmit="return validateForm();">
            ...
            <fieldset class="form-group border p-3">
              <div class="mb-3">
                ...
                <input type="text" name="nama_mhs" class="form-control" id="nama_mhs" value="{{$data->nama_mhs}}"/>
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea name="alamat" id="alamat" class="form-control" cols="30" rows="2">{{$data->alamat}}</textarea>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="universitas" class="form-control" id="universitas" value="{{$data->universitas}}"/>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="nim_mhs" class="form-control" id="nim_mhs" value="{{$data->nim_mhs}}"/>
              </div>
